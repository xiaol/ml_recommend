# -*- coding: utf-8 -*-
# @Time    : 16/9/26 上午11:32
# @Author  : liulei
# @Brief   : 提取微信公众号中广告的片段
# @File    : AdsParagraphExtract.py
...
ads_data_dir = real_path + '/../AdsClassify/news_raw'
if not os.path.exists(ads_data_dir):
    os.mkdir(ads_data_dir)
...
t = ["网络大电影", "华人瞰世界", "美国咖", "汽车爱好者", "母婴头条", "新闻夜航", "男人装", "政商参阅", "占豪", "北京知道", "严肃八卦"]
test_name = set(t)

#get_wechat_news(wechat_name_set)
...
wechat_name_set = get_wechatnum_name()
ads_dict = get_wechat_news(wechat_name_set)
