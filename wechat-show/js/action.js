...
page.get_data_list = function(isfirst,pageSize,page_num){
	...
	//var url = "http://127.0.0.1/news_process/GetWechatNames"
	//var url = "http://10.172.64.2:9999/news_process/GetWechatNames"
	var url = "http://120.55.88.11:9999/news_process/GetWechatNames"
	var request_data = {}
...
page.show_data_info = function(data){
	...
	for(var l in list){
		...
		html += '<td> <input para="'+name + ':'+list[l][0] + ':' + list[l][1]+'" type="checkbox" '+(list[l][3]==1?"checked":"")+' /> </td>';
